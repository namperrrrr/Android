...
public class Add_Edit_Product_Fragment extends Fragment {
    private Product_View_Model viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.p_fragment_add_edit_product, container, false);
        ...
        // Khởi tạo ViewModel
        viewModel = new ViewModelProvider(this).get(Product_View_Model.class);

        // Cài đặt Spinner và Quan sát dữ liệu
        setupSpinners();
        observeDropdownData();
        ...
        // Đổ dữ liệu nếu là chế độ Sửa (Edit)
        ...
        // Quan sát trạng thái lưu (Success/Error)
