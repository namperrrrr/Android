...
public class Product_List_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.p_fragment_product_list, container, false);
        ...
        fabAdd.setOnClickListener(v -> {
            getParentFragmentManager().beginTransaction()
                    .replace(R.id.mainFragmentContainer, new Add_Edit_Product_Fragment())
                    .addToBackStack(null)
                    .commit();
        });
        ...
        adapter.setOnItemClickListener(product -> {
            Add_Edit_Product_Fragment fragment = new Add_Edit_Product_Fragment();
