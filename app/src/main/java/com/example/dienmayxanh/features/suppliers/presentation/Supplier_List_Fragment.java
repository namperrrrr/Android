...
public class Supplier_List_Fragment extends Fragment {
    private Supplier_View_Model viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.s_fragment_supplier_list, container, false);
        ...
        adapter = new Supplier_Adapter();
        rvSuppliers.setAdapter(adapter);

        viewModel = new ViewModelProvider(this).get(Supplier_View_Model.class);
        ...
        fabAdd.setOnClickListener(v -> getParentFragmentManager().beginTransaction()
                .replace(R.id.mainFragmentContainer, new Add_Edit_Supplier_Fragment())
                .addToBackStack(null).commit());

        adapter.setOnItemClickListener(supplier -> {
            Add_Edit_Supplier_Fragment fragment = new Add_Edit_Supplier_Fragment();
