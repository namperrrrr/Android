...
public class Supplier_Adapter extends RecyclerView.Adapter<Supplier_Adapter.SupplierViewHolder> {
    ...
    public SupplierViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.s_item_supplier, parent, false);
    ...
    public void onBindViewHolder(@NonNull SupplierViewHolder holder, int position) {
        ...
        // Gán sự kiện click vào nút Hình Cây Bút để Sửa
