...
public class Category_List_Fragment extends Fragment {
    private Category_View_Model viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.c_fragment_category_list, container, false);
        ...
        viewModel = new ViewModelProvider(this).get(Category_View_Model.class);
        ...
        fabAdd.setOnClickListener(v -> {
            getParentFragmentManager().beginTransaction()
                    .replace(R.id.mainFragmentContainer, new Add_Edit_Category_Fragment())
                    .addToBackStack(null)
                    .commit();
        });
        ...
        adapter.setOnItemClickListener(category -> {
            Add_Edit_Category_Fragment fragment = new Add_Edit_Category_Fragment();
