...
import com.example.dienmayxanh.features.categories.domain.Category_Use_Cases;
import com.example.dienmayxanh.features.products.data.Product;
import com.example.dienmayxanh.features.products.domain.Product_UseCases;
import com.example.dienmayxanh.features.suppliers.data.Supplier;
import com.example.dienmayxanh.features.suppliers.domain.Supplier_UseCases;

import java.util.List;

public class Product_View_Model extends ViewModel {
    private Product_UseCases useCases = new Product_UseCases();
    private Category_Use_Cases categoryUseCases = new Category_Use_Cases();
    private Supplier_UseCases supplierUseCases = new Supplier_UseCases();
